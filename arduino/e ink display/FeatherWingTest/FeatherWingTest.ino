...
//  display.begin();
  ...
  testdrawtext(display_6,"six", COLOR2);
  ...
  display_1.fillScreen(COLOR1);
  display_2.fillScreen(COLOR1);
  display_3.fillScreen(COLOR1);
  display_4.fillScreen(COLOR1);
  display_5.fillScreen(COLOR1);
