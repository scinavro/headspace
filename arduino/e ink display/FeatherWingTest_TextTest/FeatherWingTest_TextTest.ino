...
void loop() {
  char WIDTH = display_1.width();
  char HEIGHT = display_1.height();
  ...
  testdrawtext(display_1,&WIDTH, COLOR1);
  testdrawtext(display_2,&HEIGHT, COLOR1);
  testdrawtext(display_3,&WIDTH, COLOR1);
  testdrawtext(display_4,&HEIGHT, COLOR1);
  testdrawtext(display_5,&WIDTH, COLOR1);
  testdrawtext(display_6,&HEIGHT, COLOR1);
